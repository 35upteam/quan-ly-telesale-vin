...
st.markdown("""
    ...
    /* Trang đăng nhập: Font chữ tự co giãn để luôn nằm trên 1 dòng */
    .brand-title { 
    ...
    /* FIX: Giao diện đăng nhập trên Mobile không bị co */
    @media (max-width: 768px) {
        /* Ép các cột của trang đăng nhập giãn 100% */
        [data-testid="column"] {
            width: 100% !important;
            flex: 1 1 100% !important;
        }
        /* Bảng dữ liệu cho phép cuộn ngang để không hỏng layout */
...
# --- 2. LOGIC ĐĂNG NHẬP (ĐÃ KHÔI PHỤC) ---
            ...
            with c_btn:
                if st.button("Tìm kiếm", key="btn_find_ma"):
                    if search_ma:
                        ...
                        if res.empty:
                            st.session_state['search_error'] = f"Không tìm thấy."
